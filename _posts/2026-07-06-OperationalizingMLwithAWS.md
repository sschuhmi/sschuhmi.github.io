...
A complete overview of all events' columns including all event types is shown in the following figure. Every single event is attached to one specific teams, i.e. the home team _or_ the away team.
